...
public class Lista_de_produtos {
    ...
    @Generated
    public Lista_de_produtos(Long id, Long cod_barras, Long listaId, Long cnpj, Long situacaoId, Float quantidade, Float valor, java.util.Date data_da_compra, Boolean recente) {
        this.id = id;
